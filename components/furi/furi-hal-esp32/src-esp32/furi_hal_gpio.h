...
// TODO esp - I copied this from STM32 code
struct GPIO_TypeDef
{
...
#define LL_GPIO_PIN_11 0
#define LL_GPIO_PIN_12 0
#define LL_GPIO_PIN_13 0
#define LL_GPIO_PIN_14 0
#define LL_GPIO_PIN_15 0
#define LL_GPIO_PIN_16 0
#define LL_GPIO_PIN_17 0
#define LL_GPIO_PIN_18 0
#define LL_GPIO_PIN_19 0
 ...
 */
typedef struct {
    struct GPIO_TypeDef* const port;
    uint16_t pin;
} GpioPin;
 ...
 */
static inline void
    furi_hal_gpio_write_port_pin(/*GPIO_TypeDef**/ void* port, uint16_t pin, const bool state) {
    // writing to BSSR is an atomic operation
    // TODO esp
    /*if(state == true) {
        port->BSRR = pin;
 ...
 * @return true / false
 */
static inline bool furi_hal_gpio_read_port_pin(/*GPIO_TypeDef**/void* port, uint16_t pin) {
    // TODO esp
    return false;
